module test_time_module
   ...
   !                                                                               
   !-------------------------------------------------------------------------------
   !  $Id: test_time_module.f90 141112 2022-04-22 14:12:55Z spee $
   !  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/delft3dfm/141476/src/test/utils_lgpl/deltares_common/packages/test_deltares_common/src/test_time_module.f90 $
   !!--description-----------------------------------------------------------------
   !

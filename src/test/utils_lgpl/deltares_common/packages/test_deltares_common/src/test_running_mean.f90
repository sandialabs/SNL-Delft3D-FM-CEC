module test_running_mean
   ...
   !                                                                               
   !-------------------------------------------------------------------------------
   !  $Id: test_running_mean.f90 140618 2022-01-12 13:12:04Z klapwijk $
   !  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/delft3dfm/141476/src/test/utils_lgpl/deltares_common/packages/test_deltares_common/src/test_running_mean.f90 $
   !!--description-----------------------------------------------------------------
   !

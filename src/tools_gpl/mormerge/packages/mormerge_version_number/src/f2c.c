...
// $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/tools_gpl/mormerge/packages/mormerge_version_number/src/f2c.c $
#include <string.h>

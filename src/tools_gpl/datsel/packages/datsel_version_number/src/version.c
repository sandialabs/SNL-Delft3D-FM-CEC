...
// $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/tools_gpl/datsel/packages/datsel_version_number/src/version.c $
#include <stdlib.h>
#include <stdio.h>
#include <string.h>

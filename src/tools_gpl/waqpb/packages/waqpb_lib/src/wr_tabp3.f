...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: wr_tabp3.f 65778 2020-01-14 14:07:42Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/tools_gpl/waqpb/packages/waqpb_lib/src/wr_tabp3.f $

      SUBROUTINE WR_TABP3 ( DEFFDS      ,
     +                      NO_FORT     , FORT_ID     ,
     +                      LUNREP      , IERROR      )
C
C     Deltares
...
C
C     FUNCTION           :  Write TABLE_P3 group to NEFIS file
C

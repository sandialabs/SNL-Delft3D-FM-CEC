...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: wr_tabr8.f 65778 2020-01-14 14:07:42Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/tools_gpl/waqpb/packages/waqpb_lib/src/wr_tabr8.f $

      SUBROUTINE WR_TABR8 ( DEFFDS      ,
     +                      NO_DSTO     , R8_DID      ,
     +                      R8_SID      , R8_SCAL     ,
     +                      LUNREP      , IERROR      )
C
...
C
C     FUNCTION           :  Write TABLE_R8 group to NEFIS file
C
...
C     NO_DSTO      INT            I       number of rows in table R8
C     R8_DID       CHA*10 NO_DSTO I       velocity identification
C     R8_SID       CHA*10 NO_DSTO I       substance identification
C     R8_SCAL      REAL   NO_DSTO I       scale factor

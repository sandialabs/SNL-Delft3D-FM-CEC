...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: wr_tabr6.f 65778 2020-01-14 14:07:42Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/tools_gpl/waqpb/packages/waqpb_lib/src/wr_tabr6.f $

      SUBROUTINE WR_TABR6 ( DEFFDS      ,
     +                      NO_STOC     , R6_FID      ,
     +                      R6_SID      , R6_SCAL     ,
     +                      LUNREP      , IERROR      )
C
...
C
C     FUNCTION           :  Write TABLE_R6 group to NEFIS file
C
...
C     NO_STOC      INT            I       number of rows in table r3
C     R6_FID       CHA*10 NO_STOC I       flux identification
C     R6_SID       CHA*10 NO_STOC I       substance identification
C     R6_SCAL      REAL   NO_STOC I       scale factor

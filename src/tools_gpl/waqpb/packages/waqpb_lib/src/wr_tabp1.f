...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: wr_tabp1.f 65778 2020-01-14 14:07:42Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/tools_gpl/waqpb/packages/waqpb_lib/src/wr_tabp1.f $

      SUBROUTINE WR_TABP1 ( DEFFDS      ,
     +                      NO_SGRP     , SGRP_ID     ,
     +                      SGRP_NAME   , LUNREP      ,
     +                      IERROR      )
C
...
C
C     FUNCTION           :  Write TABLE_P1 group to NEFIS file
C
...
C     NO_SGRP      INT            I       number of substance groups
C     ITEM_ID      CHA*10 NO_SGRP I       unique substance group identification
C     ITEM_NAME    CHA*50 NO_SGRP I       substance group name

...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: wr_tabr1.f 65778 2020-01-14 14:07:42Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/tools_gpl/waqpb/packages/waqpb_lib/src/wr_tabr1.f $
...
C
C     FUNCTION           :  Write TABLE_R1 group to NEFIS file
C
...
C     CON_PRO      INT    NO_CONF*I       configuration process table
...
C
      INTEGER       NO_CONF     , NO_PROC ,
     +              LUNREP      , IERROR
      INTEGER       DEFFDS
      INTEGER       CON_PRO(NO_CONF,NO_PROC)
C
C     Local variables
C

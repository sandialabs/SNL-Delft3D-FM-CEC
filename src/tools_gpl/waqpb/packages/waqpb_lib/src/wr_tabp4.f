...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: wr_tabp4.f 65778 2020-01-14 14:07:42Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/tools_gpl/waqpb/packages/waqpb_lib/src/wr_tabp4.f $

      SUBROUTINE WR_TABP4 ( DEFFDS      ,
     +                      NO_PROC     , PROC_ID     ,
     +                      PROC_NAME   , PROC_FORT   ,
     +                      PROC_TRCO   , LUNREP      ,
     +                      IERROR      )
...
C
C     FUNCTION           :  Write TABLE_P4 group to NEFIS file
C

...
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/trunk/src/utils_lgpl/hyd_to_waq_part_lib/packages/hyd_to_waq_part_lib/src/write_data.f90 $
...
!
 ...
 2050 format ( 5(e12.6,1x) )
 2060 format ( i8, ' ; time')
 2070 format ( 5(e12.6,1x) )

subroutine depfil_double(lundia    ,error     ,fildep    ,fmttmp    ,array     , &
                       & nfld      ,ifld      ,dims      )
!----- LGPL --------------------------------------------------------------------
!                                                                               
...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: depfil_double.f90 65778 2020-01-14 14:07:42Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/utils_lgpl/deltares_common/packages/deltares_common_mpi/src/depfil_double.f90 $
!!--description----------------------------------------------------------------- 
! 
...
! 
 ...
 10    continue 
       ...
       elseif (iocond /= 0) then 
          ...
          ! 
          call dfbroadc ( dtmp, nmaxgl*mmaxgl, dfdble, error, errmsg ) 
          if ( error ) then
             call write_error(errmsg, unit=lundia)
          else
             ! 

module time_module_tests
   ...
   !  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/utils_lgpl/deltares_common/packages/deltares_common/src/time_module_tests.f90 $
   !!--description-----------------------------------------------------------------
   !

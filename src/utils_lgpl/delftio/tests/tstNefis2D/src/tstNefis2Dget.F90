...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: tstNefis2Dget.F90 140618 2022-01-12 13:12:04Z klapwijk $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/delft3dfm/141476/src/utils_lgpl/delftio/tests/tstNefis2D/src/tstNefis2Dget.F90 $
...
!   Open file for storing results
    ...
    open(newunit=resLun,file='TESTNefis2D-res.txt')

...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: tst-his-put-1D.F90 65778 2020-01-14 14:07:42Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/utils_lgpl/delftio/tests/tstHis/src/tst-his-put-1D.F90 $
program his_put_1D
...
!   Put HIS OUT data for each timestop
    ...
    do i = 1, 50
        call DioPltPut (hisOutSet, i*2, values, .true. )
        values = values + 0.1

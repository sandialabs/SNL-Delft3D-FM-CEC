...
//
//------------------------------------------------------------------------------
// $Id: test_16.c 7992 2018-01-09 10:27:35Z mourits $
// $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal/src/utils_lgpl/nefis/tests/test_999/test_16.c $
#include <stdio.h>
#include <string.h>
#include "nefis.h"
int main()

...
//
//------------------------------------------------------------------------------
// $Id: test_03.c 65778 2020-01-14 14:07:42Z mourits $
// $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/utils_lgpl/nefis/tests/test_03/test_03.c $
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
int main()
{
  ...
  strcpy(dat_file,"data_c03.dat");
  strcpy(def_file,"data_c03.def");
 ...
 */
  ...
  strcpy(dat_file,"data_c03.dta");
  strcpy(def_file,"data_c03.dfe");

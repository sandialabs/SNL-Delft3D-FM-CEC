...
!  $Id: ec_spatial_extrapolation.f90 59695 2018-07-31 15:43:19Z leander $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/trunk/src/utils_lgpl/ec_module/packages/ec_module/src/ec_spatial_extrapolation.f90 $

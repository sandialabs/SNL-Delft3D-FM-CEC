...
//
//------------------------------------------------------------------------------
// $Id: test_01.c 140618 2022-01-12 13:12:04Z klapwijk $
// $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/delft3dfm/141476/src/utils_lgpl/esmfsm/tests/test_01/test_01.c $
#if defined(WIN32)
#  include <io.h>
#else
#  include <sys/types.h>

...
/* $Id: fort-v2compat.c 5717 2016-01-12 11:35:24Z mourits $ */
...
#if 0
/*
 * Divide a mapping vector specified in units of bytes by the size of the
 * relevant element.
 */
static void
maps_divide(const ptrdiff_t* basis, int rank, size_t size, ptrdiff_t* maps)
{
    int	i;

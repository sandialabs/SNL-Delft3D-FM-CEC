module HRextensions
   ...
   !
   !-------------------------------------------------------------------------------
   !  $Id: HRextensions.f90 68319 2021-02-14 21:00:50Z jagers $
   !  $URL: https://svn.oss.deltares.nl/repos/delft3d/tags/delft3dfm/141476/src/third_party_open/swan/src/HRextensions.f90 $
   !!--description-----------------------------------------------------------------

...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: gtdpnt.f90 65778 2020-01-14 14:07:42Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/engines_gpl/flow2d3d/packages/data/src/allocation/gtdpnt.f90 $
!!--description-----------------------------------------------------------------
!
!   Look up a double pointer name using FSM
...
!
    ...
    ! array pointer
    !
    gtdpnt = getptr(pntnam(:ind - 1))
    if (gtdpnt==0) then
       call errpnt(pntnam, 'double', 'lookup', gdp)

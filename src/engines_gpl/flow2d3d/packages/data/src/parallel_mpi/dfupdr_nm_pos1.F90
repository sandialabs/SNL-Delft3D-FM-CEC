subroutine dfupdr_nm_pos1 ( field, ks, ke, gdp )
!----- GPL ---------------------------------------------------------------------
!                                                                               
...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: dfupdr_nm_pos1.F90 65778 2020-01-14 14:07:42Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/engines_gpl/flow2d3d/packages/data/src/parallel_mpi/dfupdr_nm_pos1.F90 $
!!--description-----------------------------------------------------------------
!
...
!
    real(fp), dimension(gdp%d%nmlb:gdp%d%nmub,ks:ke), intent(inout) :: field ! real array for which halo values must be copied from neighbouring subdomains
!
! Local variables
!
...
!
    ...
    !
    itag = 2
    call dfsendr_nm_pos1 ( field, work, worksize, ks, ke, request, itag, gdp )
    call dfwaitr_nm_pos1 ( field, work, worksize, ks, ke, request, itag, i(kcs), gdp )
    !
    deallocate(work)
end subroutine dfupdr_nm_pos1

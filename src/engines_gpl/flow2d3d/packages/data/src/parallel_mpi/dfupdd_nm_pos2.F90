subroutine dfupdd_nm_pos2 ( field, ks, ke, gdp )
!----- GPL ---------------------------------------------------------------------
!                                                                               
...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: dfupdd_nm_pos2.F90 65778 2020-01-14 14:07:42Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/engines_gpl/flow2d3d/packages/data/src/parallel_mpi/dfupdd_nm_pos2.F90 $
!!--description-----------------------------------------------------------------
!
...
!
    ...
    real(hp), dimension(ks:ke,gdp%d%nmlb:gdp%d%nmub), intent(inout) :: field !  real array for which halo values must be copied from neighbouring subdomains
!
! Local variables
!
...
!
    ...
    !
    itag = 2
    call dfsendd_nm_pos2 ( field, work, worksize, ks, ke, request, itag, gdp )
    call dfwaitd_nm_pos2 ( field, work, worksize, ks, ke, request, itag, i(kcs), gdp )
    !
    deallocate(work)
end subroutine dfupdd_nm_pos2

...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: swan_flow_grid_maps.f90 7992 2018-01-09 10:27:35Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal/src/engines_gpl/wave/packages/data/src/swan_flow_grid_maps.f90 $
!!--description-----------------------------------------------------------------
! NONE
...
subroutine alloc_and_get_grid(i_grid, g,grid_name,grid_file_type,xy_loc, flowLinkConnectivity, filename)
   ...
   select case(grid_file_type)
      ...
      case ('NC')
          ...
          call read_netcdf_grd(i_grid, g%grid_name, g%x   ,g%y    ,g%kcs ,g%covered, g%mmax, g%nmax ,g%kmax, g%sferic, g%xymiss, filename, flowLinkConnectivity)
      case default

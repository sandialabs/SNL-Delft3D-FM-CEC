...
! $Id: gettauswave.f90 141422 2022-07-01 11:52:50Z spee $
! $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/delft3dfm/141476/src/engines_gpl/dflowfm/packages/dflowfm_kernel/src/dflowfm_kernel/compute/gettauswave.f90 $
         ...
         do k=1,ndx
            ...
            do nn = 1,nd(k)%lnx
               ...
               if (frcn > 0d0 .and. hu(LL) > 0d0) then
                  ...
                  z00 = z00 + ar*z0urou(LL)
                  !z00 = z00 + ar*hu(LL)*exp(-1d0 - vonkar*cz/sag)
               endif
            enddo
            if (wa > 0d0) then
               cfn = cfn / wa

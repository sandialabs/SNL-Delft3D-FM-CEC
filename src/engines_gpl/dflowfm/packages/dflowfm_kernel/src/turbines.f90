...
!> @brief Read turbine data from input file
!!
!! @param[in]      filtrb       turbine definition file name
!! @param[in]      lundia       diagnostic file unit number
!! @param[inout]   turbines     structure_turbines type
!! @param[out]     %error       returns .true. if file read fails
...
!> @brief Display turbine data
!!
!! @param[in]      turbines     structure_turbines type
!! @param[in]      lundia       diagnostic file unit number
...
!> @brief Determine locations of turbines on grid
!!
!! @param[inout]   turbines     structure_turbines type
!! @param[out]     %error       returns .true. on memory error
...
!> @brief Apply momentum sink on flow and calculate power generated by turbines
!!
!! @param[inout]   turbines     structure_turbines type
...
!> @brief Write NEFIS elements of constants group
!!
!! @param[in]      turbines     structure_turbines type
!! @param[in]      fds
!! @param[in]      grpnam
...
!> @brief Write NEFIS elements of time-varying group
!!
!! @param[in]      turbines     structure_turbines type
!! @param[in]      fds
!! @param[in]      grpnam

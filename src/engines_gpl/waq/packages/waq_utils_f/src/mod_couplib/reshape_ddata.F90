...
!-- VERSION HISTORY ----------------------------------------------------------
!
!   $URL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/engines_gpl/waq/packages/waq_utils_f/src/mod_couplib/reshape_ddata.F90 $
...
!-- SUBROUTINE reshape_ddata -------------------------------------------------
!   Author:             Edwin Vollebregt (VORtech)
!-- DESCRIPTION --------------------------------------------------------------
!!
!!  Reshape a DOUBLE field: fill part of array FLDOUT using values from array
...
!!<
!-----------------------------------------------------------------------------
subroutine reshape_ddata(inrlp, &
...
!  print debug-information on the operation to be performed
   ...
   if (idebug.ge.2) then
      write(LOUT,'(a,i2,3a)') ' reshape_data: starting for inrlp=',inrlp,&
         ' ("', trim(inrlp_names(inrlp)),'"); double precision data'

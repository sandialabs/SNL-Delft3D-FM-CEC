...
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/delft3dfm/141476/src/utils_gpl/morphology/packages/morphology_data/src/sediment_basics_module.f90 $
!!--module description----------------------------------------------------------
!

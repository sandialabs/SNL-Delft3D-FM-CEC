...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: flow1d_io_properties.f90 8044 2018-01-24 15:35:11Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal/src/utils_gpl/flow1d/packages/flow1d_io/src/general/flow1d_io_properties.f90 $
!!--description-----------------------------------------------------------------
! NONE
!!--pseudo code and references--------------------------------------------------
! NONE
!!--declarations----------------------------------------------------------------
    use flow1d_io_tree_structures
    !
    implicit none
    !
    ...
    do
       ...
       if (line(1:1)=='[') then
          ...
          do i = 1, len_trim(value)
             node_value_helper(i)(1:1) = value(i:i)
          enddo
           
          call tree_put_data( anode, node_value_helper(1:len_trim(value)), "STRING")
...
end module flow1d_io_properties

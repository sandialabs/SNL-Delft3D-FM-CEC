...
!
!-------------------------------------------------------------------------------
!  $Id: flow1d_io_tree_struct.f90 8044 2018-01-24 15:35:11Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal/src/utils_gpl/flow1d/packages/flow1d_io/src/general/flow1d_io_tree_struct.f90 $
! tree_struct.f90 --
...
!
module flow1d_io_TREE_DATA_TYPES
   type TREE_DATA
...
end module flow1d_io_TREE_DATA_TYPES

module flow1d_io_TREE_STRUCTURES
   use flow1d_io_TREE_DATA_TYPES
   implicit none
   ...
   character(len=1), dimension(maxlen), public,save :: node_value_helper
...
end module flow1d_io_TREE_STRUCTURES

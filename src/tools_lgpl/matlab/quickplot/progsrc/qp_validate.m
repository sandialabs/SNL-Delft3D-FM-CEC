...
%   $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/delft3dfm/141476/src/tools_lgpl/matlab/quickplot/progsrc/qp_validate.m $
%   $Id: qp_validate.m 140618 2022-01-12 13:12:04Z klapwijk $
...
switch log_style
    case 'latex'
        if strcmp(casename,'MAIN')
            ...
            fn = fopen(logid);
            [~,f,e] = fileparts(fn);
            str = '$Id: qp_validate.m 140618 2022-01-12 13:12:04Z klapwijk $';
            if str(1) == '$'
                dollar = '';
            else
                dollar = '$';

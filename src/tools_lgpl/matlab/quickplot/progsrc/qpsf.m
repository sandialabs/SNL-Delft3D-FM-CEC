...
%   $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal_v3/src/tools_lgpl/matlab/quickplot/progsrc/qpsf.m $
%   $Id: qpsf.m 65778 2020-01-14 14:07:42Z mourits $

if nargin>0
    d3d_qp('selectfigure',handleIn);
end
if nargout>0
    handleOut = d3d_qp('selectedfigure');
end

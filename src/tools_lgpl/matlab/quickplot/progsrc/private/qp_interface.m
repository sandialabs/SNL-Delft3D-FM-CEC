...
%   $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/SANDIA/fm_tidal/src/tools_lgpl/matlab/quickplot/progsrc/private/qp_interface.m $
%   $Id: qp_interface.m 7992 2018-01-09 10:27:35Z mourits $
...
qp_tooltip(MW.MN2XY,'Copy M index path to plain M index (losing selection order)')
%
...
%
Top = PMsize(2)-10;
Width = PMsize(1)-60-45-panewidth;
...
setappdata(PM.Fig,'FigPropsHeight',Top-80-(Top-170)+10)
setappdata(PM.Fig,'FigPropsShift',60)
%
%------- Axes Properties
%
Line = Top-110;
PM.AxNameTxt = uicontrol('Parent',PM.Fig, ...
    'Position',[10 Line 40 17], ...
    'Style','text', ...
    'Horizontalalignment','left', ...
    'String','Name');
PM.AxName = uicontrol('Parent',PM.Fig, ...
    'Position',[60 Line 200 20], ...
    'Style','edit', ...
    'Horizontalalignment','left', ...
    'Callback','d3d_qp axesname', ...
    'Enable','off');
PM.AxTypeTxt = uicontrol('Parent',PM.Fig, ...
    'Position',[270 Line 30 17], ...
    'Style','text', ...
    'Horizontalalignment','left', ...
    'String','Type');
PM.AxType = uicontrol('Parent',PM.Fig, ...
    'Position',[310 Line 90 20], ...
    'Style','popupmenu', ...
    'Horizontalalignment','left', ...
    'string',{' '}, ....
...
PM.XLabelTxt = uicontrol('Parent',PM.Fig, ...
    ...
    'String','X Label', ...
    'Enable','off');
PM.XLabelAuto = uicontrol('Parent',PM.Fig, ...
    'Position',[60 Line 60 17], ...
    'Style','checkbox', ...
    'Horizontalalignment','left', ...
    'Enable','off', ...
...
PM.YLabelTxt = uicontrol('Parent',PM.Fig, ...
    ...
    'String','Y Label', ...
    'Enable','off');
PM.YLabelAuto = uicontrol('Parent',PM.Fig, ...
    'Position',[60 Line 60 17], ...
    'Style','checkbox', ...
    'Horizontalalignment','left', ...
    'Enable','off', ...
...
%
Line = Line-30;
PM.ZLimitTxt = uicontrol('Parent',PM.Fig, ...
    'Position',[10 Line 50 17], ...
    'Style','text', ...
    'Horizontalalignment','left', ...
    'String','Z Limit', ...
    'Enable','off');
PM.ZLimitMin = uicontrol('Parent',PM.Fig, ...
    'Position',[60 Line 60 20], ...
    'Style','edit', ...
    'Horizontalalignment','right', ...
    'Callback','d3d_qp axeslimits', ...
    'Enable','off');
PM.ZLimitMax = uicontrol('Parent',PM.Fig, ...
    'Position',[130 Line 60 20], ...
    'Style','edit', ...
    'Horizontalalignment','right', ...
    'Callback','d3d_qp axeslimits', ...
    'Enable','off');
PM.ZScale = uicontrol('Parent',PM.Fig, ...
    'Position',[200 Line 60 20], ...
    'Style','popupmenu', ...
    'Horizontalalignment','left', ...
    'Enable','off', ...
    'Callback','d3d_qp axesscale', ...
    'String',{'Linear','Log'});
PM.ZGrid = uicontrol('Parent',PM.Fig, ...
    'Position',[270 Line 60 17], ...
    'Style','checkbox', ...
    'Horizontalalignment','left', ...
    'Enable','off', ...
    'Callback','d3d_qp axesgrid', ...
    'String','Z Grid');
PM.ZLoc = uicontrol('Parent',PM.Fig, ...
    'Position',[340 Line 60 20], ...
    'Style','popupmenu', ...
    'Horizontalalignment','left', ...
    'Enable','off', ...
    'Callback','d3d_qp axesloc', ...
    'String',{'Left','Right'});
PM.ZColor = uicontrol('Parent',PM.Fig, ...
    'Position',[410 Line 20 20], ...
    'Style','pushbutton', ...
    'Enable','off', ...
    'Callback','d3d_qp zcolour', ...
    'String','');
Line = Line-30;
PM.ZLabelTxt = uicontrol('Parent',PM.Fig, ...
    'Position',[10 Line 50 17], ...
    'Style','text', ...
    'Horizontalalignment','left', ...
    'String','Z Label', ...
    'Enable','off');
PM.ZLabelAuto = uicontrol('Parent',PM.Fig, ...
    'Position',[60 Line 60 17], ...
    'Style','checkbox', ...
    'Horizontalalignment','left', ...
    'Enable','off', ...
    'Callback','d3d_qp zlabel', ...
    'String','Auto');
PM.ZLabel = uicontrol('Parent',PM.Fig, ...
    'Position',[130 Line 270 20], ...
    'Style','edit', ...
    'Horizontalalignment','left', ...
    'Callback','d3d_qp zlabel', ...
...
PM.AxHandles = [PM.AxNameTxt PM.AxName PM.AxTypeTxt PM.AxType PM.SecondY ...
    ...
    PM.XLabelTxt PM.XLabelAuto PM.XLabel ...
    PM.YLimitTxt PM.YLimitMin PM.YLimitMax PM.YScale PM.YGrid PM.YLoc PM.YColor ...
    PM.YLabelTxt PM.YLabelAuto PM.YLabel ...
    PM.ZLimitTxt PM.ZLimitMin PM.ZLimitMax PM.ZScale PM.ZGrid PM.ZLoc PM.ZColor ...
    PM.ZLabelTxt PM.ZLabelAuto PM.ZLabel];
PM.Handles = [PM.Handles PM.AxHandles];
PM.Pane(end+1:length(PM.Handles)) = {'Axes Properties'};
setappdata(PM.Fig,'AxPropsHeight',Top-80-Line+10)
...
%
voffset=voffset-50;
LocTextPopup_pair(mfig,'Plot Coordinate','plotcoordinate',[offset voffset width 20],'');
%
% ------ vector style ...
%
voffset=voffset-50;

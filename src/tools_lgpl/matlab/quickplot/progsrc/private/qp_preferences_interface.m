...
%   $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/delft3dfm/141476/src/tools_lgpl/matlab/quickplot/progsrc/private/qp_preferences_interface.m $
%   $Id: qp_preferences_interface.m 140618 2022-01-12 13:12:04Z klapwijk $
...
handles(end+1)=uicontrol('style','popupmenu', ...
    ...
    'value',i, ...
    'tag','defaultrenderer', ...
    'callback','d3d_qp defaultrenderer', ...
    'backgroundcolor',Active, ...
    'horizontalalignment','left', ...
    'parent',mfig);
%-------------
VOffset = VOffset-25;
smo = qp_settings('graphicssmoothing');
handles(end+1)=uicontrol('style','checkbox', ...
    'position',[HOffset+100 VOffset dims(2)-121 20], ...
    'string','Graphics Smoothing', ...
    'value',smo, ...
    'tag','defaultsmoothing', ...
    'callback','d3d_qp defaultsmoothing', ...
    'horizontalalignment','left', ...
    'parent',mfig);
%--------------------------------------------------------------------------
Panes(end+1,1:2)={'Default Figure' handles};
...
%--------------------------------------------------------------------------
Panes(end+1,1:2)={'Default Axes' handles};
set(handles,'visible','off')
%=============
handles=[]; VOffset = dims(2)-Margin-20;
%--------------------------------------------------------------------------
